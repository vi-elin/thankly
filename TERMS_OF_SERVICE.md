...
- Customize notification settings and preferences
- Use the app in English or Ukrainian

All data is stored locally on your device. We do not provide cloud storage or synchronization services.

## 3. User Eligibility

You must be at least 13 years old to use the App. If you are between 13 and 18 years of age, you should use the App under the supervision of a parent or legal guardian.
...
- Maintain the security of your device and any backup credentials
- Be responsible for all content you create within the App
...
Your privacy is important to us. The text of your gratitude entries is stored exclusively on your device and is never transmitted to us. We do use Google Firebase for basic analytics, crash reporting, and app-version checks, which involves sending limited technical data (not your journal content) to Google's servers. For full details, please review our [Privacy Policy](PRIVACY_POLICY.md).
...
The App uses local notifications to remind you to practice gratitude. You can control these notifications through the App settings or your device settings. Notifications are generated locally on your device and do not involve any external servers.

## 9. Updates and Modifications

- **App Updates**: We may release updates to improve functionality, fix bugs, or add new features. You are encouraged to keep the App updated to the latest version.
- **Terms Updates**: We reserve the right to modify these Terms at any time. We will notify you of material changes by updating the "Last Updated" date. Your continued use of the App after changes constitutes acceptance of the new Terms.

## 10. Termination

You may stop using the App at any time by uninstalling it from your device. Uninstalling the App will delete all locally stored data. We reserve the right to discontinue the App or any features at any time without notice.

## 11. Third-Party Services

The App uses Google Firebase (Analytics, Crashlytics, and Remote Config) for app stability and usage insights, as described in our [Privacy Policy](PRIVACY_POLICY.md). This and any other third-party libraries or frameworks used by the App are governed by their own terms and conditions. We are not responsible for any third-party services or their content.
...
Any disputes arising from these Terms or your use of the App shall be resolved through good faith negotiations. If a resolution cannot be reached, disputes shall be subject to the exclusive jurisdiction of the courts of Poland, without prejudice to any mandatory consumer-protection rights you may have under the laws of your country of residence.
